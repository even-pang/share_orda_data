; (function ($) {
	...
	$.fn.slideShow = function(options) {
		...
		return this.each(function() {
			...
			var $stopBtn = $('#stopBtn');		//슬라이드 정지 버튼	
			...
			$stopBtn.click(function(){
				...
				if (mFlag == "F") {
					AutoPlayStart();
					mFlag = "";
					document.getElementById("stop_icon").src="/home/images/main/btn_pop02.gif";
				} else {
					AutoPlayStop();
					mFlag = 'F';
					document.getElementById("stop_icon").src="/home/images/main/btn_pop_play.gif";
				}
	...
	jQuery.fn.slideShow.defaults = {
		...
		slideWidth: 172,					//가로사이즈
		slideHeight: 210,					//세로사이즈
